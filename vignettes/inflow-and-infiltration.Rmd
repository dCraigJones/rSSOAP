...
## Workflow
- _CLEAN_ *raw data* into *scrubbed*
- _ISOLATE_ a *signal* from *scrubbed*
- _SHAPE_ *scrubbed* into a *hydrograph*
- _MODEL_ *hydrograph* into a *response*
- _REPORT_ *error* from *response*
...
